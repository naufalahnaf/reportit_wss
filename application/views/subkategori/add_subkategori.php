		...
		<div class="col-lg-6 p-3">
			<div class="card">
			  <div class="card-header">
			  	<h3 class="my-auto"><i class="fas fa-fw fa-plus"></i> Tambah SubKategori</h3>
			  </div>
			  <div class="card-body">
			  	<form action="<?= base_url('subkategori/addSubKategori'); ?>" method="post">
					...
					<div class="form-group">
						...
						<input type="text" id="subkategori" class="form-control <?= (form_error('subkategori')) ? 'is-invalid' : ''; ?>" name="subkategori" required value="<?= set_value('subkategori'); ?>">
						<div class="invalid-feedback">
