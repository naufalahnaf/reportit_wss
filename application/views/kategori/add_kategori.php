		...
		<div class="col-lg-6 p-3">
			<div class="card">
			  <div class="card-header">
			  	<h3 class="my-auto"><i class="fas fa-fw fa-plus"></i> Tambah Kategori</h3>
			  </div>
			  <div class="card-body">
			  	<form action="<?= base_url('kategori/addKategori'); ?>" method="post">
					<div class="form-group">
						<label for="kategori">Kategori</label>
						<input type="text" id="kategori" class="form-control <?= (form_error('kategori')) ? 'is-invalid' : ''; ?>" name="kategori" required value="<?= set_value('kategori'); ?>">
