		...
		<div class="col-lg-6 p-3">
			<div class="card">
			  <div class="card-header">
			  	<h3 class="my-auto"><i class="fas fa-fw fa-plus"></i> Tambah Waroeng</h3>
			  </div>
			  <div class="card-body">
			  	<form action="<?= base_url('waroeng/addWaroeng'); ?>" method="post">
					...
					<div class="form-group">
						...
						<input type="text" id="waroeng" class="form-control <?= (form_error('waroeng')) ? 'is-invalid' : ''; ?>" name="waroeng" required value="<?= set_value('waroeng'); ?>">
						<div class="invalid-feedback">
			              <?= form_error('waroeng'); ?>
			            </div>
					</div>
