<?php 
    // Mengambil id_pengguna dari session atau parameter GET
    $id_pengguna = $this->session->userdata('id_pengguna'); // atau bisa menggunakan $this->input->get('id_pengguna');

    // Menambahkan filter id_pengguna pada setiap query
    $proses = $this->db->get_where('pengaduan', ['status_pengaduan' => 'proses', 'id_pengguna' => $id_pengguna])->num_rows();
    $valid = $this->db->get_where('pengaduan', ['status_pengaduan' => 'valid', 'id_pengguna' => $id_pengguna])->num_rows();
    $pengerjaan = $this->db->get_where('pengaduan', ['status_pengaduan' => 'pengerjaan', 'id_pengguna' => $id_pengguna])->num_rows();
    $selesai = $this->db->get_where('pengaduan', ['status_pengaduan' => 'selesai', 'id_pengguna' => $id_pengguna])->num_rows();
    $tidak_valid = $this->db->get_where('pengaduan', ['status_pengaduan' => 'tidak_valid', 'id_pengguna' => $id_pengguna])->num_rows();
    $belum_ditanggapi = $this->db->get_where('pengaduan', ['status_pengaduan' => 'belum_ditanggapi', 'id_pengguna' => $id_pengguna])->num_rows();
?>
